    ...
    <div>
        ...
        <div class="table-container">
            <el-table :data="tableData" size="medium " :row-style="{ height: '56px' }" height="695px">
                ...
                <el-table-column prop="date" label="VWAP滑点值标准差"> </el-table-column>
                <el-table-column prop="name" label="收益率标准差"> </el-table-column>
                <el-table-column prop="date" label="贴合度"> </el-table-column>
