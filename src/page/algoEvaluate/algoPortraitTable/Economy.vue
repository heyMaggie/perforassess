    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>经济性</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <el-form :inline="true" :model="searchForm" class="demo-form-inline search-row">
            ...
            <div class="button-right">
                ...
                <el-button type="plain" v-has="4" @click="downLoad"
...
export default {
    ...
    methods: {
        getTableData(pageObj = { page: 1, pageNum: 10 }) {
            ...
            let query = { profile_type: 1, start_time, end_time, page: pageObj.page, limit: pageObj.pageNum, ...this.searchForm };
            console.log(query);
